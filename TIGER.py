#decompiled by CLB-29
import os, sys
print '\x1b[1;32mMasukan ID: AbdulBasitKamboh dan Password: Pakistan untuk Login dan jangan lupa login facebook di OperaMini dulu sebelum login agar tidak CekPoint'
print '\x1b[1;32mSilahkan Login '
import os, sys

def wa():
    os.system('xdg-open https://web.facebook.com/pythz)
...
if sandi == 'Pakistan' and user == 'AbdulBasitKamboh':
    print 'Anda Telah Login'
    sys.exit
else:
    print 'Login GAGAL, ABDUL BASIT KAMBOH ADMIN'
    wa()
    restart()
    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                a = x.hexdigest()
                data.update({'sig': a})
                url = 'https://web.facebook.com/pythz '
                ...
                os.system('xdg-open https://github.com/CLB-09')
                time.sleep(2)
                menu()
